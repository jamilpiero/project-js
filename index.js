...
function read(text) {
  ...
  if (text == "what is your name") {
    ...
    speech.text =
      "very bad especially the  preparation in the subject of head  sir is even worse ";
    ...
    speech.text =
      "Sajeeb Ahmed Fida. Fida is a very good boy, he doesnot like math ";
    ...
    speech.text =
      "Maisha Islam is a good  girl, she looks very pretty cute ! 😍 ";
  } else if (text == "Maisha ki pochondo kore?") {
  } else if (text == "what is your mother name") {
    speech.text =
      "my mother name is Maisha Islam. Maisha Islam is a good  girl, she looks very pretty cute ! 😍 ";
  ...
  } else if (text == "Who is Tanme") {
    speech.text =
      "Tanme is that girl who is loved by jamil alot, jamil loves her so much";
